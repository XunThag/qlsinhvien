...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Nhật ký sinh viên hàng ngày</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Lọc/ Xuất danh sách sang Excel</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Lọc danh sách Sinh viên:</h3>
            ...
            <div class="modal-body">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      <div class="panel-heading">Lọc theo ngày:</div>
                      <div class="panel-body">
                      <label for="Start-Date"><b>Chọn ngày từ:</b></label>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one">Thời gian vào</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two">Thời gian ra</label>
                        </div>
                      </div>
                      <div class="panel-body">
                        <label for="Start-Time"><b>Chọn thời gian từ:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Đến thời gian:</b></label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Lọc theo Lớp:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Xuất sang Excel:</b></label>
